...
export class AllOrdersComponent implements OnInit {
  ...
  constructor(public orderService: OrdersService, private route: ActivatedRoute, private store: Store, httpClient: HttpClient) {
  ...
  loadDetail(id: any) {
    console.log(id)
    this.orderService.loadDetails(id).subscribe()
  }
